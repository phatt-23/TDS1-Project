...
ALTER TABLE z_category 
    ADD CONSTRAINT z_category_PK PRIMARY KEY ( category_id ) ;
...
ALTER TABLE z_channel 
    ADD CONSTRAINT z_channel_PK PRIMARY KEY ( channel_id ) ;
...
ALTER TABLE z_comment 
    ADD CONSTRAINT z_comment_PK PRIMARY KEY ( comment_id ) ;
...
ALTER TABLE z_comment_audit 
    ADD CONSTRAINT z_comment_audit_PK PRIMARY KEY ( audit_id ) ;
...
ALTER TABLE z_image_media 
    ADD CONSTRAINT z_image_media_PK PRIMARY KEY ( media_id ) ;
...
ALTER TABLE z_media 
    ADD CONSTRAINT z_media_PK PRIMARY KEY ( media_id ) ;
...
ALTER TABLE z_playlist 
    ADD CONSTRAINT z_playlist_PK PRIMARY KEY ( playlist_id ) ;
...
ALTER TABLE z_playlist_video 
    ADD CONSTRAINT z_playlist_video_PK PRIMARY KEY ( playlist_id, video_id ) ;
...
ALTER TABLE z_reaction 
    ADD CONSTRAINT z_reaction_PK PRIMARY KEY ( reaction_id ) ;

CREATE TABLE z_subscription 
    ( 
     user_id                 INTEGER  NOT NULL , 
     channel_id              INTEGER  NOT NULL , 
     notification_preference CHAR (1) DEFAULT '1'  NOT NULL , 
...
ALTER TABLE z_user 
    ADD CONSTRAINT z_user_PK PRIMARY KEY ( user_id ) ;
...
ALTER TABLE z_user_audit 
    ADD CONSTRAINT z_user_audit_PK PRIMARY KEY ( audit_id ) ;
...
CREATE TABLE z_video 
    ( 
     ...
     is_monetized       CHAR (1) DEFAULT '1'  NOT NULL , 
     is_deleted         CHAR (1) DEFAULT '0'  NOT NULL 
    ) 
;
CREATE UNIQUE INDEX z_video__IDX ON z_video 
    ( 
     thumbnail_media_id ASC 
    ) 
;
CREATE UNIQUE INDEX z_video__IDXv1 ON z_video 
    ( 
     video_media_id ASC 
    ) 
;
...
ALTER TABLE z_video 
    ADD CONSTRAINT z_video_PK PRIMARY KEY ( video_id ) ;
...
ALTER TABLE z_video_audit 
    ADD CONSTRAINT z_video_audit_PK PRIMARY KEY ( audit_id ) ;

CREATE TABLE z_video_category 
    ( 
     z_video_category_z_video_FK    INTEGER  NOT NULL , 
     z_video_category_z_category_FK INTEGER  NOT NULL 
    ) 
;

ALTER TABLE z_video_category 
    ADD CONSTRAINT z_video_category_PK PRIMARY KEY ( z_video_category_z_video_FK, z_video_category_z_category_FK ) ;
...
ALTER TABLE z_video_media 
    ADD CONSTRAINT z_video_media_PK PRIMARY KEY ( media_id ) ;
...
ALTER TABLE z_video_view 
    ADD CONSTRAINT z_video_view_PK PRIMARY KEY ( video_view_id ) ;
...
ALTER TABLE z_video_category 
    ...
    ( 
     z_video_category_z_category_FK
    ) 
    REFERENCES z_category 
    ( 
     category_id
...
CREATE OR REPLACE TRIGGER FKNTO_z_playlist 
BEFORE UPDATE OF channel_id, user_id 
ON z_playlist 
FOR EACH ROW 
BEGIN 
 IF :old.channel_id IS NOT NULL THEN 
  raise_application_error(-20225,'Non Transferable FK constraint z_playlist_z_channel_FK on table z_playlist is violated'); 
 END IF; 
 IF :old.user_id IS NOT NULL THEN 
  raise_application_error(-20225,'Non Transferable FK constraint z_playlist_z_user_FK on table z_playlist is violated'); 
 END IF; 
END; 
/
...
CREATE OR REPLACE TRIGGER FKNTM_z_user_audit 
BEFORE UPDATE OF user_id 
ON z_user_audit 
BEGIN 
  raise_application_error(-20225,'Non Transferable FK constraint  on table z_user_audit is violated'); 
END; 
/
